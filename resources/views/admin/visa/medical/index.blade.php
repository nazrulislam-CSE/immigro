                    ...
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                        <p class="card-title my-0">
                            ...
                            <span class="badge bg-danger side-badge"
                                style="font-size:17px;">{{ count($medicalVisas) }}</span>
                        </p>
                        <div class="d-flex">
                            ...
                            @foreach ($medicalVisas as $key => $visa)
                                <div class="col-md-3 mb-4">
                                    <div class="card shadow-lg border-0 h-100">
                                        <a href="{{ route('admin.medical.visa.show', $visa->id) }}">
                                            <!-- Flag -->
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div class="d-flex justify-content-center gap-2 mt-3">
                                                ...
                                                @if ($admin && $admin->hasRole('Super Admin'))
                                                    <a href="{{ route('admin.medical.visa.edit', $visa->id) }}"
                                                        class="btn btn-primary btn-sm me-1" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                @endif
                                                @if ($admin && $admin->hasRole('Super Admin'))
                                                    <a href="{{ route('admin.medical.visa.delete', $visa->id) }}"
