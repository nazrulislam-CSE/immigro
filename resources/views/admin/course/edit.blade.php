                   ...
                   <div class="form-group col-xl-12 col-lg-12 col-md-6">
                        ...
                        @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             <span class="input-group-text" title="Course Name" id="basic-addon1"><i class="fas fa-users" title="Course Name"></i></span>
                             <input type="text" value="{{ $course->name }}" class=" form-control" name="name" placeholder="Course Name">
                         </div>
                     </div>
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-paper-plane"></i> Update Course</button>
                    </div>
                </div>
            </form>
        </div>
