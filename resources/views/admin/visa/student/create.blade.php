...
<div class="main-content-body">
    <div class="row row-sm">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.student.visa.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="country_name" id="country_name" class="form-control"
                                   placeholder="e.g., Canada" value="{{ old('country_name') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="slug" id="slug" class="form-control" readonly
                                   placeholder="auto-generated from country name" value="{{ old('slug') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img id="showFlag" src="{{ asset('upload/no_image.jpg') }}" width="80" class="mt-2">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img id="showLogo" src="{{ asset('upload/no_image.jpg') }}" width="80" class="mt-2">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="program" id="program" class="form-control"
                                   placeholder="e.g., Computer Science" value="{{ old('program') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="versity_name" id="versity_name" class="form-control"
                                   placeholder="e.g., University of Toronto" value="{{ old('versity_name') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="intake" id="intake" class="form-control"
                                   placeholder="e.g., Fall 2024, Spring 2025" value="{{ old('intake') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="ielts" id="ielts" class="form-control"
                                   placeholder="e.g., 6.5 overall" value="{{ old('ielts') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="application_fee" id="application_fee"
                                   class="form-control" placeholder="0.00" value="{{ old('application_fee', 0) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="averse_tution_fee" id="averse_tution_fee"
                                   class="form-control" placeholder="0.00" value="{{ old('averse_tution_fee', 0) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="acommodation_cost" id="acommodation_cost"
                                   class="form-control" placeholder="0.00" value="{{ old('acommodation_cost', 0) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="processing_time" id="processing_time" class="form-control"
                                   placeholder="e.g., 4-6 weeks" value="{{ old('processing_time') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="medical_fee" id="medical_fee"
                                   class="form-control" placeholder="0.00" value="{{ old('medical_fee', 0) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="service_charge" id="service_charge" class="form-control"
                                   placeholder="e.g., $500" value="{{ old('service_charge') }}">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="documents" id="documents" class="form-control summernote"
                                      placeholder="List all required documents...">{{ old('documents') }}</textarea>
                        </div>

                        <div class="form-group col-md-12">
                            <button type="submit" class="btn btn-primary">Save Student Visa</button>
                        </div>
                    </div>
                </form>
            </div>
