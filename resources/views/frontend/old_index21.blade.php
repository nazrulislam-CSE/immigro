...
@section('content')
    <style>
        ...
        @media (max-width: 768px) {
            .slider-image {
                ...
                /* Optional – photo gap হলে কালো ব্যাকগ্রাউন্ড */
            }
        }
            ...
            @foreach ($sliders as $key => $slider)
                <div class="carousel-item {{ $key === 0 ? 'active' : '' }}">
                    <div class="slider-image"
                        style="background-image: url('{{ asset('upload/slider/' . $slider->image) }}');"></div>
                </div>
            @endforeach
        </div>
    ...
    <!-- package start -->
    <section class="package package-bg pos-rel pb-120 pt-100"
        data-background="{{ asset('frontend/assets/img/bg/package_bg.jpg') }}">
        <div class="container">
            <div class="sec-title sec-title--travel text-center mb-55">
                <span class="subtitle">Popular Package</span>
            ...
            <div class="row mt-none-30">
                    ...
                    <div class="xb-package mt-30">
                        <div class="xb-item--inner">
                            <div class="xb-item--img">
                                <a href="#!"><img src="{{ asset('frontend/assets/img/package/img_01.jpg') }}"
                                        alt=""></a>
                            </div>
                            <div class="xb-item--holder">
                                <div class="xb-item--meta ul_li_between mb-15">
                                    <div class="xb-item--country ul_li">
                                        <img src="{{ asset('frontend/assets/img/country/img_01.png') }}" alt="">
                                        <span>Canda</span>
                                    </div>
                                ...
                                <h2 class="xb-item--title"><a href="#!">Discover the Wonders of Paris: A French
                                        Escapade</a></h2>
                                <ul class="xb-item--info ul_li_between">
                                    <li><img src="{{ asset('frontend/assets/img/icon/clock.svg') }}" alt=""> 02 Days
                                        1 Night</li>
                                    <li><img src="{{ asset('frontend/assets/img/icon/user-2.svg') }}" alt="">12
                                        People</li>
                                </ul>
                                <a class="xb-item--btn" href="#!">Package Start with - <span>$299</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="xb-package mt-30">
                        <div class="xb-item--inner">
                            <div class="xb-item--img">
                                <a href="#!"><img src="{{ asset('frontend/assets/img/package/img_02.jpg') }}"
                                        alt=""></a>
                            </div>
                            <div class="xb-item--holder">
                                <div class="xb-item--meta ul_li_between mb-15">
                                    <div class="xb-item--country ul_li">
                                        <img src="{{ asset('frontend/assets/img/country/img_02.png') }}" alt="">
                                        <span>Belgium</span>
                                    </div>
                                    <div class="xb-item--rating ul_li">
                                        <span>4.8</span>
                                ...
                                <h2 class="xb-item--title"><a href="#!">Unearth the Treasures of Egypt: A Pharaoh's
                                        Journey</a></h2>
                                <ul class="xb-item--info ul_li_between">
                                    <li><img src="{{ asset('frontend/assets/img/icon/clock.svg') }}" alt=""> 02
                                        Days 1 Night</li>
                                    <li><img src="{{ asset('frontend/assets/img/icon/user-2.svg') }}" alt="">12
                                        People</li>
                                </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="xb-package mt-30">
                        <div class="xb-item--inner">
                            <div class="xb-item--img">
                                <a href="#!"><img src="{{ asset('frontend/assets/img/package/img_03.jpg') }}"
                                        alt=""></a>
                            </div>
                            <div class="xb-item--holder">
                                <div class="xb-item--meta ul_li_between mb-15">
                                    <div class="xb-item--country ul_li">
                                        <img src="{{ asset('frontend/assets/img/country/img_03.png') }}" alt="">
                                        <span>Denmark</span>
                                    </div>
                                    <div class="xb-item--rating ul_li">
                                        <span>4.8</span>
                                ...
                                <h2 class="xb-item--title"><a href="#!">Roam the Streets of Rome: An Italian
                                        Odyssey</a></h2>
                                <ul class="xb-item--info ul_li_between">
                                    <li><img src="{{ asset('frontend/assets/img/icon/clock.svg') }}" alt=""> 03
                                        Days 1 Night</li>
                                    <li><img src="{{ asset('frontend/assets/img/icon/user-2.svg') }}" alt="">08
                                        People</li>
                                </ul>
                                <a class="xb-item--btn" href="#!">Package Start with - <span>$288</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="xb-package mt-30">
                        <div class="xb-item--inner">
                            <div class="xb-item--img">
                                <a href="#!"><img src="{{ asset('frontend/assets/img/package/img_04.jpg') }}"
                                        alt=""></a>
                            </div>
                            <div class="xb-item--holder">
                                <div class="xb-item--meta ul_li_between mb-15">
                                    <div class="xb-item--country ul_li">
                                        <img src="{{ asset('frontend/assets/img/country/img_04.png') }}" alt="">
                                        <span>Australia</span>
                                    </div>
                                    <div class="xb-item--rating ul_li">
                                        <span>4.8</span>
                                ...
                                <h2 class="xb-item--title"><a href="#!">The Beauty of Budapest: A Hungarian
                                        Sojourn</a></h2>
                                <ul class="xb-item--info ul_li_between">
                                    <li><img src="{{ asset('frontend/assets/img/icon/clock.svg') }}" alt=""> 04
                                        Days 1 Night</li>
                                    <li><img src="{{ asset('frontend/assets/img/icon/user-2.svg') }}" alt="">12
                                        People</li>
                                </ul>
                                <a class="xb-item--btn" href="#!">Package Start with - <span>$400</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="xb-package mt-30">
                        <div class="xb-item--inner">
                            <div class="xb-item--img">
                                <a href="#!"><img src="{{ asset('frontend/assets/img/package/img_05.jpg') }}"
                                        alt=""></a>
                            </div>
                            <div class="xb-item--holder">
                                <div class="xb-item--meta ul_li_between mb-15">
                                    <div class="xb-item--country ul_li">
                                        <img src="{{ asset('frontend/assets/img/country/img_05.png') }}" alt="">
                                        <span>France</span>
                                    </div>
                                    <div class="xb-item--rating ul_li">
                                        <span>4.8</span>
                                ...
                                <h2 class="xb-item--title"><a href="#!">Historic Charms of Athens: A Greek
                                        Getaway</a></h2>
                                <ul class="xb-item--info ul_li_between">
                                    <li><img src="{{ asset('frontend/assets/img/icon/clock.svg') }}" alt=""> 04
                                        Days 1 Night</li>
                                ...
                                <a class="xb-item--btn" href="#!">Package Start with - <span>$350</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="xb-package mt-30">
                        <div class="xb-item--inner">
                            <div class="xb-item--img">
                                <a href="#!"><img src="{{ asset('frontend/assets/img/package/img_06.jpg') }}"
                                        alt=""></a>
                            </div>
                            <div class="xb-item--holder">
                                <div class="xb-item--meta ul_li_between mb-15">
                                    <div class="xb-item--country ul_li">
                                        <img src="{{ asset('frontend/assets/img/country/img_06.png') }}" alt="">
                                        <span>Germany</span>
                                    </div>
                                    <div class="xb-item--rating ul_li">
                                        <span>4.8</span>
                                ...
                                <h2 class="xb-item--title"><a href="#!">Tropical Paradise: Escape to Bali,
                                        Indonesia</a></h2>
                                <ul class="xb-item--info ul_li_between">
                                    <li><img src="{{ asset('frontend/assets/img/icon/clock.svg') }}" alt=""> 05
                                        Days 1 Night</li>
                                    <li><img src="{{ asset('frontend/assets/img/icon/user-2.svg') }}" alt="">12
                                        People</li>
                                </ul>
                                <a class="xb-item--btn" href="#!">Package Start with - <span>$310</span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <h2 class="xb-strock-text">Adventure world</h2>
    </section>
    <!-- package end -->

    <!-- destination start -->
    <section class="destination-section pos-rel pt-120 pb-120">
        <div class="container-fluid">
            <div class="sec-title sec-title--travel text-center mb-55">
                <span class="subtitle">Discover New Destination</span>
                <h2>Popular Destination</h2>
            </div>
            <div class="row gap-40 mt-none-40">
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="xb-destination mt-40">
                        <div class="xb-item--img">
                            <img src="{{ asset('frontend/assets/img/destination/img_01.jpg') }}" alt="">
                            <div class="xb-item--holder">
                                <h3 class="xb-item--title">(maldives - Indonesian)</h3>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="xb-destination style-video mt-40">
                        <div class="xb-item--img">
                            <a class="popup-video" href="https://www.youtube.com/watch?v=cRXm1p-CNyk"><img
                                    src="{{ asset('frontend/assets/img/destination/img_02.jpg') }}" alt=""></a>
                    ...
                    <div class="xb-destination mt-40">
                        <div class="xb-item--img">
                            <img src="{{ asset('frontend/assets/img/destination/img_03.jpg') }}" alt="">
                            <div class="xb-item--holder">
                                <h3 class="xb-item--title">(Chana - Rashia)</h3>
                                <span>280 Tour Packages</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="xb-destination mt-40">
                        <div class="xb-item--img">
                            <img src="{{ asset('frontend/assets/img/destination/img_04.jpg') }}" alt="">
                            <div class="xb-item--holder">
                                <h3 class="xb-item--title">(Canada - Ukraine)</h3>
                                <span>280 Tour Packages</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="xb-destination mt-40">
                        <div class="xb-item--img">
                            <img src="{{ asset('frontend/assets/img/destination/img_05.jpg') }}" alt="">
                            <div class="xb-item--holder">
                                <h3 class="xb-item--title">(poland - Indonesian)</h3>
                                <span>280 Tour Packages</span>
                            </div>
                        </div>
                    </div>
                    <div class="xb-destination style-video mt-40">
                        <div class="xb-item--img">
                            <a class="popup-video" href="https://www.youtube.com/watch?v=cRXm1p-CNyk"><img
                                    src="{{ asset('frontend/assets/img/destination/img_06.jpg') }}" alt=""></a>
                            <a class="xb-item--play popup-video" href="https://www.youtube.com/watch?v=cRXm1p-CNyk"><i
                                    class="fas fa-play"></i></a>
                        </div>
                    </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide xb-category">
                    <div class="xb-item--inner">
                        ...
                        <h3 class="xb-item--title">Romantic Place</h3>
                        <a class="xb-item--link" href="#!"></a>
                    </div>
                </div>
                <div class="swiper-slide xb-category">
                    <div class="xb-item--inner">
                        <div class="xb-item--icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34"
                                fill="none">
                                <path
                                    d="M9.71273 28.5582C8.90817 29.1769 7.91369 29.5598 6.82248 29.5598C4.1928 29.5598 2.05296 27.42 2.05296 24.7903C2.05296 22.1601 4.1928 20.0202 6.82248 20.0202C8.80719 20.0202 10.5094 21.2405 11.227 22.9686L12.7206 21.4196C11.5444 19.3667 9.35789 17.9673 6.82248 17.9673C3.05394 17.9673 0 21.0219 0 24.7903C0 28.5582 3.05394 31.6128 6.82248 31.6128C8.5955 31.6128 10.1952 30.9198 11.4088 29.8105C10.9431 29.6542 10.5013 29.4062 10.1238 29.0427C9.96803 28.8922 9.83363 28.7278 9.71273 28.5582Z"
                                    fill="#FFBD0F" />
                                <path
                                    d="M20.0725 18.0194L16.4598 15.9211C18.0709 14.9127 17.4735 15.2861 19.0847 14.2777L19.034 14.791C18.947 15.6645 19.5908 16.4638 20.4012 16.6281C20.4206 16.632 26.7432 17.7067 26.9738 17.7067C27.7951 17.7067 28.5202 17.1132 28.6591 16.2759C28.8141 15.3437 28.184 14.4628 27.2518 14.3085L22.5971 13.5352L22.8185 11.314C23.0416 9.89458 23.1385 9.44951 22.6085 8.60271L21.9422 7.53751C21.0815 6.1628 19.2665 5.74244 17.8885 6.6052L10.5963 11.1708C8.80525 12.2922 7.93181 14.6567 9.39402 16.396C9.96526 17.0757 15.5193 20.4888 15.5193 20.4888L11.0211 25.1546C10.2339 25.9706 10.2573 27.2704 11.0739 28.057C11.4722 28.4411 11.9855 28.6323 12.4987 28.6323C13.0367 28.6323 13.574 28.4225 13.9763 28.0041L20.5188 21.2192C21.4418 20.2641 21.2253 18.689 20.0725 18.0194Z"
                                    fill="#FFBD0F" />
                                <path
                                    d="M27.7364 8.69962C29.3357 7.69789 29.8202 5.59009 28.819 3.99158C27.818 2.3917 25.7102 1.9072 24.1111 2.90831C22.5125 3.90943 22.028 6.01647 23.0285 7.61498C24.0294 9.21494 26.1373 9.70012 27.7364 8.69962Z"
                                    fill="#FFBD0F" />
                                <path
                                    d="M27.177 17.9673C23.3692 17.9673 20.3545 21.1089 20.3545 24.7903C20.3545 28.5582 23.4086 31.6128 27.177 31.6128C30.9447 31.6128 33.9995 28.5582 33.9995 24.7903C33.9995 21.0219 30.9447 17.9673 27.177 17.9673ZM27.177 29.5598C24.5473 29.5598 22.4075 27.42 22.4075 24.7903C22.4075 22.1601 24.5474 20.0202 27.177 20.0202C29.8067 20.0202 31.9466 22.1601 31.9466 24.7903C31.9466 27.42 29.8067 29.5598 27.177 29.5598Z"
                                    fill="#FFBD0F" />
                            </svg>
                        </div>
                        <h3 class="xb-item--title">Ridding Tour</h3>
                        <a class="xb-item--link" href="#!"></a>
                    </div>
                </div>
                <div class="swiper-slide xb-category">
                    <div class="xb-item--inner">
                        <div class="xb-item--icon color-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30"
                                fill="none">
                                <path d="M9.88547 24.1211L9.48129 12.7539H4.26838L3.86426 24.1211H9.88547Z"
                                    fill="#0091FF" />
                                <path d="M20.5184 12.7539L20.1143 24.1211H26.1355L25.7313 12.7539H20.5184Z"
                                    fill="#0091FF" />
                                <path d="M12.3934 12.7539L11.9893 24.1211H18.0105L17.6063 12.7539H12.3934Z"
                                    fill="#0091FF" />
                                <path d="M1.875 30H28.125V25.8789H1.875V30Z" fill="#0091FF" />
                                <path
                                    d="M1.875 9.24777V10.9961H28.125V9.24777L15 0.00384808L1.875 9.24777ZM11.875 5.99611H18.125V7.75393H11.875V5.99611Z"
                                    fill="#0091FF" />
                            </svg>
                        </div>
                        <h3 class="xb-item--title">Cultural Place</h3>
                        <a class="xb-item--link" href="#!"></a>
                    </div>
                </div>
                <div class="swiper-slide xb-category">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="xb-item--inner">
                                <div class="xb-item--author ul_li mb-100">
                                    <div class="xb-item--avatar">
                                        <img src="{{ asset('frontend/assets/img/testimonial/tm_avatar1.png')}}" alt="">
                                    </div>
                                    <h3 class="xb-item--name">Goladiria Gomez</h3>
                                </div>
                                <div class="xb-item--content mb-100">
                                    “ We couldn't have asked for a better travel agent. Their
                                    expertise in the creating bespoke itineraries for Brazil's Adventure ”
                                </div>
                                <div class="xb-item--bottom ul_li_between">
                                    <div class="xb-item--ratting">
                                        <img src="{{ asset('frontend/assets/img/icon/trustpilot.png')}}" alt="">
                                    </div>
                                    <ul class="xb-star-rating">
                                        <li><i class="fas fa-star"></i></li>
                                        <li><i class="fas fa-star"></i></li>
                        ...
                        <div class="swiper-slide xb-testimonial4">
                            <div class="xb-item--inner">
                                <div class="xb-item--author ul_li mb-100">
                                    <div class="xb-item--avatar">
                                        <img src="{{ asset('frontend/assets/img/testimonial/tm_avatar2.png')}}" alt="">
                                    </div>
                                    <h3 class="xb-item--name">Goladiria Gomez</h3>
                                </div>
                                <div class="xb-item--content mb-100">
                                    “ Easy booking options made planning our family vacation a joy.
                                    The website's user-friendly interface and extensive choices ”
                                </div>
                                <div class="xb-item--bottom ul_li_between">
                                    <div class="xb-item--ratting">
                                        <img src="{{ asset('frontend/assets/img/icon/trustpilot.png')}}" alt="">
                        ...
                        <div class="swiper-slide xb-testimonial4">
                            <div class="xb-item--inner">
                                <div class="xb-item--author ul_li mb-100">
                                    <div class="xb-item--avatar">
                                        <img src="{{ asset('frontend/assets/img/testimonial/tm_avatar3.png')}}" alt="">
                                    </div>
                                    <h3 class="xb-item--name">Goladiria Gomez</h3>
                                </div>
                                <div class="xb-item--content mb-100">
                                    “ World-class service! The team went above and to accommodate our requests and ensure
            ...
            <div class="xb-counter__wrap mt-30">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="xb-counter2">
                            <div class="xb-item--inner text-center">
                                <h2 class="xb-item--number"><span class="xbo" data-count="280">00</span><span
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="xb-counter2">
                            <div class="xb-item--inner text-center">
                                <h2 class="xb-item--number"><span class="xbo" data-count="08">00</span><span
                                        class="suffix">K</span></h2>
    ...
    <!-- blog start -->
        <section class="blog pos-rel pt-125 pb-125">
            <div class="container">
                <div class="sec-title sec-title--travel text-center mb-60">
                    <span class="subtitle">Blog & Article</span>
                    <h2>Blog & Article</h2>
                </div>
                <div class="xb-swiper-sliders">
                        ...
                        <div class="xb-testimonial-slider xb-swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide xb-swiper-slide xb-blog xb-blog3">
                                    <div class="xb-item--inner">
                                        <div class="xb-item--img">
                                            <a href="blog-single.html"><img src="{{ asset('frontend/assets/img/blog/trv_01.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="xb-item--holder">
                                            <ul class="xb-item--meta ul_li mb-20">
                                                <li><img src="{{ asset('frontend/assets/img/icon/user.svg')}}" alt="">By farugia</li>
                                                <li><img src="{{ asset('frontend/assets/img/icon/calendar.svg')}}" alt="">16 August 2023</li>
                                            </ul>
                                            <h2 class="xb-item--title border-effect"><a href="blog-single.html">10 Must-Visit Hidden Gems for Your Next Vacation 2022.</a></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide xb-swiper-slide xb-blog xb-blog3">
                                    <div class="xb-item--inner">
                                        <div class="xb-item--img">
                                            <a href="blog-single.html"><img src="{{ asset('frontend/assets/img/blog/trv_02.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="xb-item--holder">
                                            <ul class="xb-item--meta ul_li mb-20">
                                                <li><img src="{{ asset('frontend/assets/img/icon/user.svg')}}" alt="">By farugia</li>
                    ...
                    <div class="ul_li_center mt-40">
                        ...
                        <a class="thm-btn thm-btn--white thm-btn--trv mt-20" href="about.html">More blog<span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" viewBox="0 0 18 16" fill="none">
                            <path d="M6.68164 13.28L11.5716 8.9333C12.1491 8.41997 12.1491 7.57997 11.5716 7.06664L6.68164 2.71997" stroke="#0F172A" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                          </svg></span></a>
                    </div>
                </div>
            </div>
            <div class="xb-blog-shape">
                <img src="{{ asset('frontend/assets/img/shape/blog_shape.png')}}" alt="">
            </div>
        </section>
        <!-- blog end -->

        <!-- brand start -->
        <section class="brand brand-pb z-1 pos-rel" data-bg-color="#F0F2F6">
            <div class="sec-title sec-title--travel text-center mb-20">
                <span class="subtitle">Our Brand Alliances</span>
                <h2>Elevating Travel Experiences</h2>
            </div>
            <div class="xb-category-slider swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide xb-brand xb-brand2">
                        <a class="xb-item--inner" href="#!"><img src="{{ asset('frontend/assets/img/brand/trv_brand_01.png')}}" alt=""></a>
                    </div>
                    <div class="swiper-slide xb-brand xb-brand2">
                        <a class="xb-item--inner" href="#!"><img src="{{ asset('frontend/assets/img/brand/trv_brand_02.png')}}" alt=""></a>
                    </div>
                    <div class="swiper-slide xb-brand xb-brand2">
                        <a class="xb-item--inner" href="#!"><img src="{{ asset('frontend/assets/img/brand/trv_brand_03.png')}}" alt=""></a>
                    </div>
                    <div class="swiper-slide xb-brand xb-brand2">
                        <a class="xb-item--inner" href="#!"><img src="{{ asset('frontend/assets/img/brand/trv_brand_01.png')}}" alt=""></a>
                    </div>
            ...
            <h2 class="xb-strock-text-brand xb-strock-text">Pick Tour Categories</h2>
        </section>
        <!-- brand end -->
        ...
        <div class="container">
            <div class="service-wrap pos-rel">
                <div class="service-img-wrap">
                    <div class="service-bg" data-background="{{ asset('frontend/assets/img/bg/service_bg.png') }}"></div>
                    <div class="service-img wow skewIn" data-wow-delay="100ms"
                        data-background="{{ asset('frontend/assets/img/service/img_01.jpg') }}"></div>
                </div>
                        ...
                        <div class="xb-service">
                            <div class="xb-item--inner">
                                <div class="xb-item--icon color2 mb-50">
                                    <img src="{{ asset('frontend/assets/img/icon/sv_02.svg') }}" alt="">
                                </div>
                                <div class="xb-item--holder">
                        ...
                        <div class="xb-service">
                            <div class="xb-item--inner">
                                <div class="xb-item--icon color3 mb-50">
                                    <img src="{{ asset('frontend/assets/img/icon/sv_03.svg') }}" alt="">
                                </div>
                                <div class="xb-item--holder">
                        ...
                        <div class="xb-service">
                            <div class="xb-item--inner">
                                <div class="xb-item--icon color4 mb-50">
                                    <img src="{{ asset('frontend/assets/img/icon/sv_04.svg') }}" alt="">
                                </div>
                                <div class="xb-item--holder">
                        ...
                        <div class="xb-service">
                            <div class="xb-item--inner">
                                <div class="xb-item--icon color5 mb-50">
                                    <img src="{{ asset('frontend/assets/img/icon/sv_05.svg') }}" alt="">
                                </div>
                                <div class="xb-item--holder">
    ...
    <section class="about pos-rel pb-130">
        ...
        <div class="about__img">
            <img src="{{ asset('frontend/assets/img/about/about_img.png') }}" alt="">
        </div>
    </section>
    <!-- about end -->

    <!-- counter start -->
    <section class="counter pt-120 pb-120 bg_img" data-background="{{ asset('frontend/assets/img/bg/counter_bg.jpg') }}">
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="xb-counter ul_li">
                        <div class="xb-item--item ul_li">
                            <div class="xb-item--icon">
                                <img src="{{ asset('frontend/assets/img/icon/c_01.svg') }}" alt="">
                            </div>
                            <div class="xb-item--holder">
                                <h2 class="xb-item--number"><span class="xbo" data-count="20">00</span><span
                                        class="suffix">+</span></h2>
                        ...
                        <div class="xb-item--item style-2 ul_li">
                            <div class="xb-item--icon">
                                <img src="{{ asset('frontend/assets/img/icon/c_02.svg') }}" alt="">
                            </div>
                            <div class="xb-item--holder">
                        ...
                        <div class="xb-item--item style-3 ul_li">
                            <div class="xb-item--icon">
                                <img src="{{ asset('frontend/assets/img/icon/c_03.svg') }}" alt="">
                            </div>
                            <div class="xb-item--holder">
                                <h2 class="xb-item--number"><span class="xbo" data-count="40">00</span><span
                                        class="suffix">K+</span></h2>
                        ...
                        <div class="xb-item--item style-4 ul_li">
                            <div class="xb-item--icon">
                                <img src="{{ asset('frontend/assets/img/icon/c_04.svg') }}" alt="">
                            </div>
                            <div class="xb-item--holder">
                ...
                <div class="tab-pane animated fadeInUp show active" id="xbc-tab-pane1" role="tabpanel"
                    ...
                    <div class="xb-country ul_li">
                        ...
                        <div class="xb-item--item">
                            <a href="country-single.html" class="xb-item--inner ul_li">
                                <div class="xb-item--flag">
                                    <img src="{{ asset('frontend/assets/img/country/img_07.png') }}" alt="">
                                </div>
                        ...
                        <div class="xb-item--item">
                            <a href="country-single.html" class="xb-item--inner ul_li">
                                <div class="xb-item--flag">
                                    <img src="{{ asset('frontend/assets/img/country/img_08.png') }}" alt="">
                                </div>
                        ...
                        <div class="xb-item--item">
                            <a href="country-single.html" class="xb-item--inner ul_li">
                                <div class="xb-item--flag">
                                    <img src="{{ asset('frontend/assets/img/country/img_09.png') }}" alt="">
                                </div>
                        ...
                        <div class="xb-item--item">
                            <a href="country-single.html" class="xb-item--inner ul_li">
                                <div class="xb-item--flag">
                                    <img src="{{ asset('frontend/assets/img/country/img_10.png') }}" alt="">
                                </div>
                        ...
                        <div class="xb-item--item">
                            <a href="country-single.html" class="xb-item--inner ul_li">
                                <div class="xb-item--flag">
                                    <img src="{{ asset('frontend/assets/img/country/img_11.png') }}" alt="">
                                </div>
                        ...
                        <div class="xb-item--item">
                            <a href="country-single.html" class="xb-item--inner ul_li">
                                <div class="xb-item--flag">
                                    <img src="{{ asset('frontend/assets/img/country/img_12.png') }}" alt="">
                                </div>
                ...
                <div class="row justify-content-md-center mt-none-30">
                    ...
                    <div class="col-lg-4 col-md-6 mt-30">
                        <div class="xb-blog">
                            <div class="xb-item--inner">
                                <div class="xb-item--img">
                                    <a href="blog-single.html"><img src="assets/img/blog/img_02.jpg"
                                            alt=""></a>
                                </div>
                                <div class="xb-item--holder">
                                    ...
                                    <ul class="xb-item--meta ul_li mb-20">
                                        ...
                                        <li><img src="assets/img/icon/calendar.svg" alt="">16 September 2023
                                        </li>
                                    </ul>
                    ...
                    <div class="col-lg-4 col-md-6 mt-30">
                        <div class="xb-blog">
                            <div class="xb-item--inner">
                                <div class="xb-item--img">
                                    <a href="blog-single.html"><img src="assets/img/blog/img_03.jpg"
                                            alt=""></a>
                                </div>
                                <div class="xb-item--holder">
