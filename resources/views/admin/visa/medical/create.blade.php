...
<div class="main-content-body">
    <div class="row row-sm">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.medical.visa.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="country_name" id="country_name" class="form-control"
                                   placeholder="e.g., Germany" value="{{ old('country_name') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="visa_type" id="visa_type" class="form-control"
                                   placeholder="e.g., Medical Treatment, Medical Check-up" value="{{ old('visa_type') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="visa_duration" id="visa_duration" class="form-control"
                                   placeholder="e.g., 90 days, 6 months" value="{{ old('visa_duration') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="apply_fee" id="apply_fee"
                                   class="form-control" placeholder="0.00" value="{{ old('apply_fee', 0) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="processing_time" id="processing_time" class="form-control"
                                   placeholder="e.g., 10-15 business days" value="{{ old('processing_time') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="service_charge" id="service_charge" class="form-control"
                                   placeholder="e.g., $50" value="{{ old('service_charge') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="visa_fee" id="visa_fee"
                                   class="form-control" placeholder="0.00" value="{{ old('visa_fee', 0) }}">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            <button type="submit" class="btn btn-primary">Save Medical Visa</button>
                        </div>
                    </div>
                </form>
            </div>
