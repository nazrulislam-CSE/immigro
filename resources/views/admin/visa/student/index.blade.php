            ...
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                    <p class="card-title my-0">
                        {{ $pageTitle }}
                        <span class="badge bg-danger side-badge" style="font-size:17px;">{{ count($studentVisas) }}</span>
                    </p>
                    <div class="d-flex">
                        ...
                        <table class="table table-bordered text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.student.visa.show', $visa->id) }}" class="btn btn-success btn-sm me-1" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.student.visa.edit', $visa->id) }}" class="btn btn-primary btn-sm me-1" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                         <a href="{{ route('admin.student.visa.delete', $visa->id) }}" id="delete" class="btn btn-danger btn-sm" title="Delete"
                                          >
