...
<div class="breadcrumb-header justify-content-between">
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex">
                <a href="{{ route('admin.team.index')}}" class="btn btn-danger me-2">
                    <i class="fas fa-list d-inline"></i> Team List
                </a>
            </div>
        </div>
        <div class="card-body">
              ...
              <div class="row">
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       ...
                       @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $team->name }}" class=" form-control" name="name" placeholder="Enter Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('designation') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ $team->designation }}" class=" form-control" name="designation" placeholder="Enter Designation">
                         </div>
                     </div>
                    ...
                    {{-- <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $team->facebook_url }}" class=" form-control" name="facebook_url" placeholder="Enter Facebok Url">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $team->linkedin_url }}" class=" form-control" name="linkedin_url" placeholder="Enter Linkedin Url">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $team->twitter_url }}" class=" form-control" name="twitter_url" placeholder="Enter Twitter Url">
                        </div>
                    </div>
                   ...
                   <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       <img id="showImage" src="{{ (!empty($team->image)) ? url('upload/team/'.$team->image):url('upload/no_image.jpg') }}" alt="Admin" style="width:100px; height: 100px;"  >
                   </div>
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-paper-plane"></i> Update Team</button>
                    </div>
                </div>
            </form>
        </div>
