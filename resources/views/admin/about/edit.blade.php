                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-6 col-lg-6  col-md-6">
                                ...
                                @error('vission')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <textarea name="vission" id="vission">{{ $about->vission }}</textarea>
                            </div>
                            ...
                            <div class="form-group col-xl-4 col-lg-4 col-md-4">
                                <label for="image">Photo <span
                                        class="text-danger font-weight-bolder">(Size:1414,1600px)</span>:</label>
                                @error('image')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <div class="input-group">
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                                <button type="submit" class="add-to-cart btn btn-success btn-block"><i
                                        class="fas fa-paper-plane"></i> Update About</button>
                            </div>
                        </div>
                    </form>
                </div>
