       ...
       <div class="table-responsive">
          <table class="table table-bordered">
            ...
            {{-- <tr>
             ...
             <tr>
                <td>Linkedin Url</td>
                <td>{{ $team->linkedin_url ?? 'NULL' }}</td>
             </tr>
             <tr>
                <td>Twitter Url</td>
                <td>{{ $team->twitter_url ?? 'NULL' }}</td>
             </tr>
             <tr>
                <td>Whatsapp Url</td>
             ...
             <tr>
                <td>Photo</td>
                <td>
                    <img src="{{ (!empty($team->image)) ? url('upload/team/'.$team->image):url('upload/no_image.jpg') }}" width="80" alt="image" class="img-fluid">
                </td>
             </tr>
          </table>
       </div>
