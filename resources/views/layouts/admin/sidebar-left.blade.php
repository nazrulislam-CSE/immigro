      ...
      <aside class="app-sidebar sidebar-scroll">
          <div class="main-sidebar-header active">
              <a class="desktop-logo logo-light active" href="{{ route('user.home') }}">
                  <h5 class="text-uppercase font-weight-bolder text-center">{{ get_setting('site_name')->value ?? '' }}
                  </h5>
              </a>
          </div>
          <div class="main-sidemenu">
              ...
              <ul class="side-menu ">
                  ...
                  @if ($isSuperAdmin || $admin->can('view Dashboard'))
                      <li class="slide">
                          <a class="side-menu__item {{ Request::is('admin/dashboard') ? 'active' : '' }}"
                              href="{{ route('admin.admin.home') }}"><i
                                  class="side-menu__icon fas fa-th-large"></i><span
                  ...
                  @if ($isSuperAdmin || $admin->canAny(['view Agents', 'create Agents', 'edit Agents', 'delete Agents']))
                      <li class="slide">
                          <a class="side-menu__item {{ Request::is('admin/agent*') ? 'active' : '' }}"
                              data-bs-toggle="slide" href="javascript:void(0);">
                              <i class="side-menu__icon fas fa-store-alt"></i>
                          ...
                          <ul class="slide-menu">
                              ...
                              @if ($isSuperAdmin || $admin->can('view supplier payments'))
                                  <li><a class="slide-item"
                                          href="{{ route('admin.supplier-payment.index') }}">Suppliers
                                          Payments</a></li>
                              @endif
                          </ul>
                      </li>
                              ...
                              @if ($isSuperAdmin || $admin->canAny(['view Staff', 'create Staff', 'edit Staff', 'delete Staff']))
                                  @if ($isSuperAdmin || $admin->can('view staff permissions'))
                                      <li><a class="slide-item {{ Request::is('admin/staff/permissions*') ? 'active' : '' }}"
                                              href="{{ route('admin.staff.permissions.index') }}">Staff
                                              Permissions</a>
                                      </li>
                                  @endcan
                              @endif
              ...
              @if (
                  $isSuperAdmin ||
                      $admin->canAny(['view Menu Builder', 'create Menu Builder', 'edit Menu Builder', 'delete Menu Builder']))
              ...
              @if (
                  $isSuperAdmin ||
                      $admin->canAny(['view Testimonials', 'create Testimonials', 'edit Testimonials', 'delete Testimonials']))
              ...
              {{-- Branch Module --}}
              @if ($isSuperAdmin || $admin->can('view Branch'))
              ...
              {{-- Course Module --}}
              @if ($isSuperAdmin || $admin->can('view Course'))
              ...
              {{-- Education Module --}}
              @if ($isSuperAdmin || $admin->canAny(['view Education', 'create Education', 'edit Education', 'delete Education']))
                  <li class="slide {{ Request::is('admin/education*') ? 'is-expanded' : '' }}">
                      ...
                      <ul class="slide-menu">
                          ...
                          @if ($isSuperAdmin || $admin->can('create Education'))
                              <li><a class="slide-item {{ Request::is('admin/education/create') ? 'active' : '' }}"
                                      href="{{ route('admin.education.create') }}">Education Add</a></li>
                          @endif
                          @if ($isSuperAdmin || $admin->can('view Education'))
                              <li><a class="slide-item {{ Request::is('admin/education/index') ? 'active' : '' }}"
                                      href="{{ route('admin.education.index') }}">Education List</a></li>
                          @endif
                      </ul>
                  </li>
              @endif
              ...
              {{-- Visa Module --}}
              @if ($isSuperAdmin || $admin->canAny(['view work permit visa', 'view student visa', 'view medical visa']))
                  <li
                      class="slide {{ Request::is('admin/visa*') || Request::is('admin/student/visa*') || Request::is('admin/medical/visa*') ? 'is-expanded' : '' }}">
                      <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                      ...
                      <ul class="slide-menu">
                          <li class="side-menu__label1"><a href="javascript:void(0);">Visa</a></li>
                          @if ($isSuperAdmin || $admin->can('view work permit visa'))
                              <li><a class="slide-item {{ Request::is('admin/visa/index') ? 'active' : '' }}"
                                      href="{{ route('admin.visa.index') }}">Work Permit Visa List</a></li>
                          @endif
                          @if ($isSuperAdmin || $admin->can('view student visa'))
                              <li><a class="slide-item {{ Request::is('admin/student/visa/index') ? 'active' : '' }}"
                                      href="{{ route('admin.student.visa.index') }}">Student Visa List</a></li>
                          @endif
                          @if ($isSuperAdmin || $admin->can('view medical visa'))
                              <li><a class="slide-item {{ Request::is('admin/medical/visa/index') ? 'active' : '' }}"
                                      href="{{ route('admin.medical.visa.index') }}">Medical Visa List</a></li>
                          @endif
                      </ul>
                  </li>
              @endif
              ...
              {{-- Online Apply Module --}}
              @if ($isSuperAdmin || $admin->can('view online apply'))
                  <li class="slide {{ Request::is('admin/partners*') ? 'is-expanded' : '' }}">
                      ...
                      <ul class="slide-menu">
                          ...
                          <li><a class="slide-item {{ Request::is('admin/partners/apply/list') ? 'active' : '' }}"
                                  href="{{ route('admin.apply.list') }}">Apply List</a></li>
                      </ul>
                  </li>
              @endif
              ...
              @if ($isSuperAdmin || $admin->can('view Software Sale'))
                  <li class="slide {{ Request::is('admin/softwares*') ? 'is-expanded' : '' }}">
                      ...
                      <ul class="slide-menu">
                          ...
                          <li><a class="slide-item {{ Request::is('admin/software/sale/list') ? 'active' : '' }}"
                                  href="{{ route('admin.software.sale.list') }}">Software Sale List</a></li>
                      </ul>
                  </li>
              @endif
              ...
              @if ($isSuperAdmin || $admin->can('view Books'))
                  <li class="slide {{ Request::is('admin/books*') ? 'is-expanded' : '' }}">
                      ...
                      <ul class="slide-menu">
                          <li class="side-menu__label1"><a href="javascript:void(0);">Books</a></li>
                          <li><a class="slide-item {{ Request::is('admin/books/index') ? 'active' : '' }}"
                                  href="{{ route('admin.book.sale.list') }}">Books List</a></li>
                      </ul>
                  </li>
              @endif

              {{-- Products Module --}}
              @if ($isSuperAdmin || $admin->canAny(['view Products', 'create Products', 'edit Products', 'delete Products']))
                  <li class="slide {{ Request::is('admin/products*') ? 'is-expanded' : '' }}">
                      ...
                      <ul class="slide-menu">
                          ...
                          @if ($isSuperAdmin || $admin->can('view Products'))
                              <li><a class="slide-item {{ Request::is('admin/products/index') ? 'active' : '' }}"
                                      href="{{ route('admin.product.list') }}">Products List</a></li>
                          @endif
                          @if ($isSuperAdmin || $admin->can('view Products'))
                              {{-- view product orders --}}
                              <li><a class="slide-item {{ Request::is('admin/products/orders') ? 'active' : '' }}"
                                      href="{{ route('admin.product.order.list') }}">Products Order List</a>
                              </li>
                          @endif
                      </ul>
                  </li>
              ...
              {{-- Account Module --}}
              @if ($isSuperAdmin || $admin->canAny(['view income', 'view expense', 'view account statement', 'view due list']))
                  <li
                      class="slide {{ Request::is('admin/income*') || Request::is('admin/expense*') || Request::is('admin/account-statement*') || Request::is('admin/due-list*') ? 'is-expanded' : '' }}">
                      <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                          <i class="side-menu__icon fas fa-building"></i>
                      ...
                      <ul class="slide-menu">
                          ...
                          @if ($isSuperAdmin || $admin->can('view income'))
                              <li><a class="slide-item {{ Request::is('admin/income/index') ? 'active' : '' }}"
                                      href="{{ route('admin.income.list') }}">Income</a></li>
                          @endif
                          @if ($isSuperAdmin || $admin->can('view expense'))
                              <li><a class="slide-item {{ Request::is('admin/expense/index') ? 'active' : '' }}"
                                      href="{{ route('admin.expense.list') }}">Expense</a></li>
                          @endif
                          @if ($isSuperAdmin || $admin->can('view account statement'))
                              <li><a class="slide-item {{ Request::is('admin/account-statement') ? 'active' : '' }}"
                                      href="{{ route('admin.account.statement') }}">Account Statement</a></li>
                          @endif
                          @if ($isSuperAdmin || $admin->can('view due list'))
                              <li><a class="slide-item {{ Request::is('admin/due-list') ? 'active' : '' }}"
                                      href="{{ route('admin.due.list') }}">Due List</a></li>
                          @endif
                      </ul>
                  </li>
              @endif
