...
<head>
<meta charset="utf-8">
<title>Immigro | Visa & Immigrations Services</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
	...
	<header class="main-header header-style-one">
			...
			<div class="inner-container">
				...
				<div class="top-left">
					...
					<ul class="list-style-one">
						<li><i class="fa fa-envelope"></i> <a href="mailto:speakupbd24@gmail.com">speakupbd24@gmail.com</a></li>
						<li><i class="fa fa-map-marker"></i> Malopara,Rajshahi</li> 
						<li><i class="fa fa-clock"></i> Mon _ Sat: 10.00 to 6.00</li> 
					</ul>
				</div>
		...
		<div class="header-lower">
			...
			<div class="main-box">
				<div class="logo-box">
					<div class="logo"><a href="{{route('frontend.home')}}"><img src="{{asset('frontend/images/logo.png')}}" alt="" title=""></a></div>
				</div>
							...
							<li class="current dropdown"><a href="{{route('frontend.home')}}">Home</a>
								<ul>
									...
									<li class="dropdown"><a href="#">Dark Styles</a>
										<ul>
											<li><a href="index-1-dark.html">Home Dark 01</a></li>
									...
									<li class="dropdown"><a href="#">Boxed Styles</a>
										<ul>
											<li><a href="index-1-boxed.html">Home Boxed 01</a></li>
											<li><a href="index-2-boxed.html">Home Boxed 02</a></li>
											<li><a href="index-3-boxed.html">Home Boxed 03</a></li>
										</ul>
									</li>
				...
				<ul class="contact-list-one">
					<li>
						...
						<div class="contact-info-box">
							...
							<a href="tel:+8801316017328">+8801316017328</a>
						</div>
					</li>
					<li>
						<!-- Contact Info Box -->
						<div class="contact-info-box">
							...
							<a href="mailto:help@immigro.com">help@immigro.com</a>
						</div>
					</li>
					<li>
						<!-- Contact Info Box -->
		...
		<div class="search-popup">
			...
			<div class="search-inner">
				<form method="post" action="https://html.kodesolution.com/2023/immigro-html/index.html">
		...
		<div class="sticky-header">
			<div class="auto-container">
				<div class="inner-container">
					<!--Logo-->
					<div class="logo">
						<a href="index.html" title=""><img src="{{asset('frontend/images/logo-3.png')}}" alt="" title=""></a>
					</div>
				...
				<ul>
					...
					<li data-index="rs-1" data-transition="zoomout">
						...
						data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'>
							<h1>Best Visa <span class="color3">&amp;</span> <br>Immigrations <br>Services</h1>
						</div>
						...
						data-textalign="['top','top','top','top']"
						data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'>
							<div class="text">Get the best solutions for all type of visa & immigrations</div>
						</div>
						...
						data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'>
							<div class="btn-box">
								<a href="page-about.html" class="theme-btn btn-style-one"><span class="btn-title">Explore More</span></a>
								<a href="page-contact.html" class="theme-btn btn-style-two"><span class="btn-title">Contact Now</span></a>
							</div>
						</div>
					</li>
				</ul>
				...
				<div class="content-column col-xl-6 col-lg-6 col-md-12 col-sm-12 wow fadeInRight" data-wow-delay="600ms">
					<div class="inner-column">
						<div class="sec-title">
							...
							<h2>Providing the best immigration <span class="color3">services</span></h2>
					...
					<div class="inner-column wow fadeInLeft">
						<div class="row">
							<div class="column col-lg-6 col-md-6">
								<div class="image-box">
									<figure class="map"><img src="{{asset('frontend/images/icons/map.png')}}" alt=""></figure>
									<figure class="image-1 overlay-anim wow fadeInUp"><img src="{{asset('frontend/images/resource/about-1.jpg')}}" alt=""></figure>
									<figure class="image-2 overlay-anim wow fadeInRight"><img src="{{asset('frontend/images/resource/about-2.jpg')}}" alt=""></figure>
								</div>
							</div>
							<div class="column col-lg-6 col-md-6">
								<div class="image-box">
									<figure class="image-3 overlay-anim wow fadeInLeft"><img src="{{asset('frontend/images/resource/about-3.jpg')}}" alt=""></figure>
	...
	<section class="why-choose-us pt-0">
		...
		<div class="auto-container">
			...
			<div class="bottom-text">Top rated by customers & immigration firms with 100% success rate. <a href="page-service.html" class="theme-btn btn-style-two">Discover More</a></div>
		</div>
	</section>
	<!--Emd Why Choose US -->
	...
	<section class="training-section">
		...
		<div class="bg bg-image" style="background-image: url({{asset('frontend/images/resource/image-1.jpg')}})"></div>
		<div class="auto-container">
			<div class="sec-title">
			...
			<div class="carousel-outer">
				<div class="training-carousel owl-carousel owl-theme">
					...
					<div class="training-block">
						<div class="inner-box">
							<div class="image-box">
								<figure class="image"><img src="{{asset('frontend/images/resource/training-1.jpg')}}" alt=""></figure>
								<div class="overlay"><a href="page-course-details.html" class="read-more"><i class="fa fa-long-arrow-alt-right"></i></a></div>
							</div>
					...
					<div class="training-block">
						<div class="inner-box">
							<div class="image-box">
								<figure class="image"><img src="{{asset('frontend/images/resource/training-2.jpg')}}" alt=""></figure>
								<div class="overlay"><a href="page-course-details.html" class="read-more"><i class="fa fa-long-arrow-alt-right"></i></a></div>
							</div>
							<div class="lower-content">
								<a href="page-course-details.html" class="read-more"><i class="fa fa-long-arrow-alt-right"></i></a>
					...
					<div class="training-block">
						<div class="inner-box">
							<div class="image-box">
								<figure class="image"><img src="{{asset('frontend/images/resource/training-3.jpg')}}" alt=""></figure>
								<div class="overlay"><a href="page-course-details.html" class="read-more"><i class="fa fa-long-arrow-alt-right"></i></a></div>
							</div>
							<div class="lower-content">
								<a href="page-course-details.html" class="read-more"><i class="fa fa-long-arrow-alt-right"></i></a>
		...
		<div class="auto-container">
			...
			<div class="row">
				...
				<div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="page-service-details.html"><img src="{{asset('frontend/images/resource/service-1.jpg')}}" alt=""></a></figure>
							<i class="icon fa fa-graduation-cap"></i>
							<h6 class="title">Student Visa</h6>
						</div>
						<div class="content-box">
							<h6 class="title"><a href="page-service-details.html">Student Visa</a></h6>
							<div class="text">We have to a tendency to believe the idea that smart looking of any website.</div>
							<a href="page-service-details.html" class="read-more">More <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
				...
				<div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="200ms">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="page-service-details.html"><img src="{{asset('frontend/images/resource/service-2.jpg')}}" alt=""></a></figure>
							<i class="icon fa fa-briefcase"></i>
							<h6 class="title">Business Visa</h6>
						</div>
						<div class="content-box">
							<h6 class="title"><a href="page-service-details.html">Business Visa</a></h6>
							<div class="text">We have to a tendency to believe the idea that smart looking of any website.</div>
							<a href="page-service-details.html" class="read-more">More <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
				...
				<div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="page-service-details.html"><img src="{{asset('frontend/images/resource/service-3.jpg')}}" alt=""></a></figure>
							<i class="icon fa fa-family"></i>
							<h6 class="title">Family Visa</h6>
						</div>
						<div class="content-box">
							<h6 class="title"><a href="page-service-details.html">Family Visa</a></h6>
							<div class="text">We have to a tendency to believe the idea that smart looking of any website.</div>
							<a href="page-service-details.html" class="read-more">More <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
				...
				<div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="200ms">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="page-service-details.html"><img src="{{asset('frontend/images/resource/service-4.jpg')}}" alt=""></a></figure>
							<i class="icon fa fa-camera"></i>
							<h6 class="title">Tourist Visa</h6>
						</div>
						<div class="content-box">
							<h6 class="title"><a href="page-service-details.html">Tourist Visa</a></h6>
							<div class="text">We have to a tendency to believe the idea that smart looking of any website.</div>
							<a href="page-service-details.html" class="read-more">More <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
				...
				<div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="page-service-details.html"><img src="{{asset('frontend/images/resource/service-5.jpg')}}" alt=""></a></figure>
							<i class="icon fa fa-home"></i>
							<h6 class="title">Residence Visa</h6>
						</div>
						<div class="content-box">
							<h6 class="title"><a href="page-service-details.html">Residence Visa</a></h6>
							<div class="text">We have to a tendency to believe the idea that smart looking of any website.</div>
							<a href="page-service-details.html" class="read-more">More <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
				...
				<div class="cta-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms">
					<div class="inner-box">
						<h4 class="title"><a href="page-service.html">Get visa with 100% success rate</a></h4>
						<a href="page-service.html" class="theme-btn btn-style-three small">Apply Now</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="carousel-outer">
				...
				<div class="countries-carousel owl-carousel owl-theme">
					...
					<div class="country-block">
						<div class="inner-box">
							<div class="flag"><img src="{{asset('frontend/images/resource/flag-1.png')}}" alt=""></div>
					...
					<div class="country-block">
						<div class="inner-box">
							<div class="flag"><img src="{{asset('frontend/images/resource/flag-2.png')}}" alt=""></div>
					...
					<div class="country-block">
						<div class="inner-box">
							<div class="flag"><img src="{{asset('frontend/images/resource/flag-3.png')}}" alt=""></div>
					...
					<div class="country-block">
						<div class="inner-box">
							<div class="flag"><img src="{{asset('frontend/images/resource/flag-4.png')}}" alt=""></div>
					...
					<div class="country-block">
						<div class="inner-box">
							<div class="flag"><img src="{{asset('frontend/images/resource/flag-5.png')}}" alt=""></div>
					...
					<div class="country-block">
						<div class="inner-box">
							<div class="flag"><img src="{{asset('frontend/images/resource/flag-6.png')}}" alt=""></div>
		...
		<div class="large-container">
			<div class="carousel-outer">
				...
				<ul class="gallery-carousel owl-carousel owl-theme wow fadeInUp">
					<li class="gallery-item"> <a href="{{asset('frontend/images/resource/gallery-1.jpg')}}" class="lightbox-image"><img src="{{asset('frontend/images/resource/gallery-1.jpg')}}" alt=""></a> </li>
					<li class="gallery-item"> <a href="{{asset('frontend/images/resource/gallery-2.jpg')}}" class="lightbox-image"><img src="{{asset('frontend/images/resource/gallery-2.jpg')}}" alt=""></a> </li>
					<li class="gallery-item"> <a href="{{asset('frontend/images/resource/gallery-3.jpg')}}" class="lightbox-image"><img src="{{asset('frontend/images/resource/gallery-3.jpg')}}" alt=""></a> </li>
					<li class="gallery-item"> <a href="{{asset('frontend/images/resource/gallery-4.jpg')}}" class="lightbox-image"><img src="{{asset('frontend/images/resource/gallery-4.jpg')}}" alt=""></a> </li>
				</ul>
			</div>
		</div>
	</section>
				...
				<div class="testimonial-carousel owl-carousel owl-theme">
					...
					<div class="testimonial-block">
						<div class="inner-box">
							<div class="content-box">
								...
								<div class="text">I was very impresed by the remons service lorem ipsum is simply free text used by copy typing refreshing. Neque porro est qui dolorem ipsum quia.</div>
							</div>
							<div class="info-box">
					...
					<div class="testimonial-block">
						<div class="inner-box">
							...
							<div class="info-box">
								<figure class="thumb"><img src="{{asset('frontend/images/resource/testi-thumb-3.jpg')}}" alt=""></figure>
				...
				<div class="row">
					...
					<div class="title-column col-lg-7 col-md-12 wow fadeInLRight">
						<div class="inner-column">
							...
							<div class="ceo-info">
								<figure class="thumb"><img src="{{asset('frontend/images/resource/ceo-thumb.jpg')}}" alt=""></figure>
						...
						<div class="inner-column">
							<div class="form-outer">
								...
								<div class="contact-form wow fadeInLeft">
									<!--Contact Form-->
									<form method="post" action="https://html.kodesolution.com/2023/immigro-html/get" id="contact-form">
										<div class="form-group">
										...
										<div class="form-group">
											<button class="theme-btn btn-style-three" type="submit" name="submit-form"><span class="btn-title">Send a Message</span></button>
										</div>
									</form>
								</div>
								<!--End Contact Form -->
	...
	<footer class="main-footer">
		...
		<div class="auto-container">
			<div class="footer-upper">
				<div class="logo-box"><img src="{{asset('frontend/images/logo-2.png')}}" alt=""></div>
				<ul class="contact-info">
					<li>
						<i class="icon fa fa-phone-square"></i>
						<span class="title">Phone:</span>
						<div class="text"><a href="tel:+880 1316-017328">+880 1316-017328</a></div>
					</li>
					<li>
						<i class="icon fa fa-envelope"></i>
						<span class="title">Email:</span>
						<div class="text"><a href="mailto:speakupbd24@gmail.com">speakupbd24@gmail.com</a></div>
					</li>
					<li>
						<i class="icon fa fa-map-marker"></i>
						<span class="title">Address:</span>
						<div class="text">Malopara,Rajshahi</div>
					</li>
				</ul>
				<div class="btn-box">
						...
						<div class="footer-widget gallery-widget">
							...
							<div class="widget-content">
								<div class="outer clearfix">
									<figure class="image">
										<a href="#"><img src="{{asset('frontend/images/resource/project-thumb-1.jpg')}}" alt=""></a>
									</figure>
									<figure class="image">
										<a href="#"><img src="{{asset('frontend/images/resource/project-thumb-2.jpg')}}" alt=""></a>
									</figure>
									<figure class="image">
										<a href="#"><img src="{{asset('frontend/images/resource/project-thumb-3.jpg')}}" alt=""></a>
									</figure>
									<figure class="image">
										<a href="#"><img src="{{asset('frontend/images/resource/project-thumb-4.jpg')}}" alt=""></a>
									</figure>
									<figure class="image">
										<a href="#"><img src="{{asset('frontend/images/resource/project-thumb-5.jpg')}}" alt=""></a>
									</figure>
									<figure class="image">
										<a href="#"><img src="{{asset('frontend/images/resource/project-thumb-6.jpg')}}" alt=""></a>
									</figure>
								</div>
							</div>
						</div>
		...
		<div class="footer-bottom">
			<div class="auto-container">
				<div class="inner-container">
					<div class="copyright-text">&copy; Copyright reserved by <a href="https://speakupbd.com/">Speak Up Bd</a>
				</div>
			</div>
		</div>
	</footer>
