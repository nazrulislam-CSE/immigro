        ...
        <div class="card-body">
            <form action="{{ route('admin.testimonial.store')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        <label for="image">Photo <span class="text-danger font-weight-bolder">(Size:70,70px)</span>:</label>
                   ...
                   <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i>Add Testimonial</button>
                    </div>
                </div>
            </form>
        </div>
