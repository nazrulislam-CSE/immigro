    ...
    public function run(): void
    {
        $pages = [
            [
                ...
                'page_description' => 'This is Visa Service Page',
                'meta_title'       => 'visa-service',
                'keywords'         => 'about, company, info',
                'meta_description' => 'This is Visa Service page',
                'status'           => 1,
                'is_default'       => 1,
                'created_by'       => 1,
                'position'         => 2,
            ...
            [
                ...
                'page_slug'        => 'education',
                'page_description' => 'This is Education Page',
                'meta_title'       => 'visa-services',
                'keywords'         => 'about, company, info',
                'meta_description' => 'This is Education page',
                'status'           => 1,
                'is_default'       => 1,
                'created_by'       => 1,
                'position'         => 2,
            ...
            [
                ...
                'page_title'       => 'Team',
                'page_slug'        => 'Team',
                'page_description' => 'This is Team Page',
                'meta_title'       => 'team',
                'keywords'         => 'about, company, info',
                'meta_description' => 'This is Team page',
                'status'           => 1,
                'is_default'       => 1,
                'created_by'       => 1,
                'position'         => 2,
            ...
            [
                'page_name'        => 'Office address',
                'page_title'       => 'Office address',
                'page_slug'        => 'Office address',
                'page_description' => 'This is Office address Page',
                'meta_title'       => 'office-address',
                'keywords'         => 'about, company, info',
                'meta_description' => 'This is Office address page',
                'status'           => 1,
                'is_default'       => 1,
                'created_by'       => 1,
                'position'         => 2,
