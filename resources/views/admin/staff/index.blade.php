        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staffModal" id="addStaffBtn">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($member->photo)
                                            <img src="{{ asset('storage/'.$member->photo) }}" width="50" height="50" class="img-thumbnail">
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        {{-- Delete Button --}}
                                        <a href="{{ route('admin.staff.delete', $member->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="staff_name" id="staff_name" placeholder="Enter staff full name" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="mobile_number" class="form-label">Mobile Number</label>
                            <input type="text" class="form-control" name="mobile_number" id="mobile_number" placeholder="e.g., 017xxxxxxxx">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" name="academic_qualification" id="academic_qualification" placeholder="e.g., B.Sc in CSE, MBA" rows="2"></textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="experience" class="form-label">Experience</label>
                            <textarea class="form-control" name="experience" id="experience" placeholder="Previous work experience" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="present_address" class="form-label">Present Address</label>
                            <textarea class="form-control" name="present_address" id="present_address" placeholder="Current address" rows="2"></textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="permanent_address" class="form-label">Permanent Address</label>
                            <textarea class="form-control" name="permanent_address" id="permanent_address" placeholder="Permanent address" rows="2"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control salary-field" name="basic_salary" id="basic_salary" placeholder="0.00" value="0">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="house_rent" class="form-label">House Rent</label>
                            <input type="number" step="0.01" class="form-control salary-field" name="house_rent" id="house_rent" placeholder="0.00" value="0">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="medical_allowance" class="form-label">Medical Allowance</label>
                            <input type="number" step="0.01" class="form-control salary-field" name="medical_allowance" id="medical_allowance" placeholder="0.00" value="0">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="target_incentive" class="form-label">Target Incentive</label>
                            <input type="number" step="0.01" class="form-control salary-field" name="target_incentive" id="target_incentive" placeholder="0.00" value="0">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="gross_salary" class="form-label">Gross Salary</label>
                            <input type="number" step="0.01" class="form-control" name="gross_salary" id="gross_salary" placeholder="Auto-calculated" readonly value="0">
                        </div>
                    </div>
                    ...
                    <div class="row" id="mobileBankingFields" style="display: none;">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="mobile_banking_number" id="mobile_banking_number" placeholder="e.g., 017xxxxxxxx">
                        </div>
                    </div>
                    ...
                    <div class="row" id="bankFields" style="display: none;">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="e.g., Sonali Bank">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="account_name" class="form-label">Account Name</label>
                            <input type="text" class="form-control" name="account_name" id="account_name" placeholder="Name on account">
                        </div>
                        <div class="col-md-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" name="payment_amount" id="payment_amount" placeholder="Enter amount">
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#photo').change(function() {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    $('#photoPreview').html('<img src="' + e.target.result + '" width="80" class="img-thumbnail">');
                }
        ...
        function setFormMode(mode) {
            ...
            $('#staffForm input, #staffForm select, #staffForm textarea').not('#method, #form_mode, #modalSubmitBtn, [type="hidden"]').prop('disabled', isView);
            ...
            // Payment system change trigger still works but fields are disabled in view
        }
        ...
        $('.view-btn').click(function() {
            ...
            if (photo) {
                $('#photoPreview').html('<img src="{{ asset('storage') }}/' + photo + '" width="80" class="img-thumbnail">');
            } else {
                $('#photoPreview').html('');
            }
