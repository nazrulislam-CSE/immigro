...
@section('content')
    ...
    <div class="card card-primary card-outline shadow-lg mb-4">
        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex">
                <a href="{{ route('admin.country.index') }}" class="btn btn-danger me-2">
                    <i class="fas fa-list d-inline"></i> Country List
                </a>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($country->flag)
                                <img src="{{ asset('storage/' . $country->flag) }}" width="100" height="60"
