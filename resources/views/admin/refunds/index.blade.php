                                ...
                                <tbody>
                                    @foreach ($refunds as $key => $refund)
                                        <tr>
                                            ...
                                            <td>{{ $refund->reason }}</td>
                                            <td>
                                                <a href="{{ route('admin.refund.receipt', $refund->id) }}"
                                                ...
                                                @if (auth('admin')->user()->can('edit Refunds'))
                                                    <button type="button" class="btn btn-sm btn-primary edit-btn"
                                                        ...
                                                        data-reason="{{ $refund->reason }}" data-bs-toggle="modal"
                                                        data-bs-target="#refundModal">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                @endif
                                                @if (auth('admin')->user()->can('delete Refunds'))
                                                    <a href="{{ route('admin.refund.delete', $refund->id) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" name="refund_amount"
                                placeholder="Enter Refund Amount" id="refund_amount">
                        </div>
                        <div class="mb-3">
                ...
                if (clientId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            var net = (parseFloat(data.total_amount) || 0) - (parseFloat(data
                                .total_refund) || 0);
                        ...
                        error: function() {
                            ...
                            $('#client_name_display, #mobile_display, #country_display, #client_total_amount, #client_total_refund, #client_net_balance')
                                .val('');
                            if (callback) callback();
                        }
                    });
