                                ...
                                <tbody>
                                    @foreach ($clients as $key => $client)
                                        <tr>
                                            ...
                                            <td>৳ {{ number_format($client->total_refund, 2) }}</td> 
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="transport_number"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="client_name"
                                        id="client_name{{ $client->id }}" value="{{ $client->client_name }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="phone_number{{ $client->id }}" class="form-label">Phone Number</label>
                                    <input type="text" class="form-control" name="phone_number"
                                        id="phone_number{{ $client->id }}" value="{{ $client->phone_number }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="country_name"
                                        id="country_name{{ $client->id }}" value="{{ $client->country_name }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="work_category{{ $client->id }}" class="form-label">Work
                                        Category</label>
                                    <input type="text" class="form-control" name="work_category"
                                        id="work_category{{ $client->id }}" value="{{ $client->work_category }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="processing_time{{ $client->id }}" class="form-label">Processing
                                        Time</label>
                                    <input type="text" class="form-control" name="processing_time"
                                        id="processing_time{{ $client->id }}" value="{{ $client->processing_time }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="date"
                                        id="date{{ $client->id }}"
                                        value="{{ $client->date ? $client->date->format('Y-m-d') : '' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="visa_category{{ $client->id }}" class="form-label">Visa
                                        Category</label>
                                    <select class="form-control" name="visa_category"
                                        id="visa_category{{ $client->id }}">
                                        <option value="">Select Visa Category</option>
                                        <option value="Work permit"
                                            {{ $client->visa_category == 'Work permit' ? 'selected' : '' }}>Work permit
                                        </option>
                                        <option value="Student visa"
                                            {{ $client->visa_category == 'Student visa' ? 'selected' : '' }}>Student visa
                                        </option>
                                        <option value="Medical visa"
                                            {{ $client->visa_category == 'Medical visa' ? 'selected' : '' }}>Medical visa
                                        </option>
                                        <option value="Tourist visa"
                                            {{ $client->visa_category == 'Tourist visa' ? 'selected' : '' }}>Tourist visa
                                        </option>
                                        <option value="Umrah visa"
                                            {{ $client->visa_category == 'Umrah visa' ? 'selected' : '' }}>Umrah visa
                                        </option>
                                        <option value="Double entry visa"
                                            {{ $client->visa_category == 'Double entry visa' ? 'selected' : '' }}>Double
                                            entry visa</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="transport_number{{ $client->id }}" class="form-label">Transport
                                        Number</label>
                                    <input type="text" class="form-control" name="transport_number"
                                        id="transport_number{{ $client->id }}"
                                        value="{{ $client->transport_number }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="total_amount{{ $client->id }}" class="form-label">Total Amount</label>
                                    <input type="number" step="0.01" class="form-control" name="total_amount"
                                        id="total_amount{{ $client->id }}" value="{{ $client->total_amount }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
