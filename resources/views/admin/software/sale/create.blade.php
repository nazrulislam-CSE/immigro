...
<div class="main-content-body">
    <div class="row row-sm">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.software.sale.store') }}" method="post">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="software_name" id="software_name" class="form-control"
                                   placeholder="e.g., CRM Pro" value="{{ old('software_name') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="url" name="demo_link" id="demo_link" class="form-control"
                                   placeholder="https://example.com/demo" value="{{ old('demo_link') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="sell_comission" id="sell_comission" class="form-control"
                                   placeholder="0.00" value="{{ old('sell_comission', 0) }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="monthly_charge" id="monthly_charge" class="form-control"
                                   placeholder="0.00" value="{{ old('monthly_charge', 0) }}">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="facilities" id="facilities" class="form-control summernote"
                                      placeholder="Describe the software facilities...">{{ old('facilities') }}</textarea>
                        </div>
