            ...
            <form action="{{ route('admin.destination.store')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('package_count') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group">
                            <span class="input-group-text" title="Package Count" id="basic-addon1"><i class="fas fa-clock"></i></span>
                            <input type="text" name="package_count" id="package_count" class="form-control" placeholder="Enter Package Count" value="{{ old('package_count') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-5 col-lg-5 col-md-5">
                            <label for="image">Destination Photo <span class="text-danger font-weight-bolder">(Size:351,234px)</span>:</label>
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i> Add Destination</button>
                    </div>
                </div>
            </form>
        </div>
