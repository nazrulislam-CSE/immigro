                ...
                <form action="{{ route('admin.income.store') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="income_category" class="form-control" value="{{ old('income_category') }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Total Amount <span class="text-danger">*</span></label>
                            <input type="number" step="0.01" name="total_amount" id="total_amount" class="form-control" required value="{{ old('total_amount') }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Payment Amount <span class="text-danger">*</span></label>
                            <input type="number" step="0.01" name="payment_amount" id="payment_amount" class="form-control" required value="{{ old('payment_amount',0) }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Due Amount</label>
                            <input type="number" step="0.01" name="due_amount" id="due_amount" class="form-control" readonly value="{{ old('due_amount',0) }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Date</label>
...
<script>
    $(document).ready(function() {
        ...
        calculateDue(); // initial calculation
    });
</script>
@endpush