...
@section('content')
   ...
   <div class="breadcrumb-header d-flex justify-content-between align-items-center">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                        <p class="card-title my-0">Menu Builder Create <span class="badge bg-danger side-badge"
                                style="font-size:17px;">{{ count($categories) }}</span> </p>
                                            ...
                                            <div class="input-group mb-3">
                                                <select required name="menu" class="form-control custom-select">
                                                    ...
                                                    @foreach ($menus as $menu)
                                                        <option @if (Request::get('menu') == $menu->id) selected @endif
                                                            value="{{ $menu->id }}">{{ $menu->name }}</option>
                                                    @endforeach
                                                </select>
                                                <button class="btn btn-primary text-light"> <i class="si si-plus"></i>
                                                    Select</button>
                                            </div>
                                        </form>
                                    @endif
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card overflow-hidden @if (count($menus) == 0 || !$desiredMenu) disabled @endif">
                        <div class="card-header pb-0">
                            <h3 class="card-title">Add Menu Items</h3> <hr>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="panel-group1" id="accordion11">
                                <div class="panel panel-default  mb-4">
                                    <div class="panel-heading1 bg-success">
                                        <h4 class="panel-title1">
                                            <a class="accordion-toggle collapsed" data-bs-toggle="collapse"
                                                data-bs-parent="#accordion11" href="#collapseFour2" aria-expanded="false"><i
                                                    class="fe fe-arrow-right me-2"></i>Pages
                                            </a>
                                        </h4>
                                    </div>
                                            ...
                                            <div class="item-list-body">
                                                ...
                                                <div class="col-12 mt-2">
                                                    <div
                                                        class="custom-control custom-checkbox custom-control-success custom-control-lg mb-1 ">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="select-all-pages" name="example-cb-custom-success-lg1"
                                                            value="all">
                                                        <label class="custom-control-label" for="select-all-pages"
                                                            style="cursor: pointer;">Select All</label>
                                                        <strong id="pages"
                                                            class="text-danger font-weaight-bolder"></strong>
                                                        <button class="btn btn-success btn-sm" id="add-pages"
                                                            style=" float:right;">
                                                            <i class="si si-plus"></i> Add
                                                        </button>
                                                    </div>
                                        ...
                                        <div class="panel-body border">
                                            <div class="item-list-body">
                                                <div class="col-12" id="custom-list">
                                                    <div class="form-group">
                                                        <label>URL <strong id="url_required"
                                                                class="text-danger font-weaight-bolder"></strong></label>
                                                        <input type="url" name="url" id="url"
                                                            class="form-control" placeholder="https://">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Link Text <strong id="linktext_required"
                                                                class="text-danger font-weaight-bolder"></strong></label>
                                                ...
                                                <div class="col-12 mt-2">
                                                    <div
                                                        class="custom-control custom-checkbox custom-control-success custom-control-lg mb-1 ">
                                                        <strong id="customLink"
                                                            class="text-danger font-weaight-bolder"></strong>
                                                        <button class="btn btn-success btn-sm" id="add-custom-link"
                                                            style=" float:right;">
                                                            <i class="si si-plus"></i> Add
                                                        </button>
                                                    </div>
                ...
                <div class="col-lg-8">
                    <div class="col-lg-12 col-md-12">
                        <div class="card overflow-hidden">
                            <div class="card-header pb-0">
                                <h3 class="card-title">Menu Structure</h3> <hr> 
                            </div>
                            <div class="card-body">
                                <div class="panel-group1" id="accordion11">
                                    <div class="mb-4">
                                        @if (Request::get('menu') == 'new')
                                            <h5 class="mb-2">Create New Menu</h5>
                                            <hr>
                                            <form method="post" action="{{ route('admin.menu.store') }}"
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-xl-12 col-lg-12 col-md-6">
                                                        <label for="name">Menu Name: <span
                                                                class="text-danger"></span></label>
                                                        @error('name')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <div class="input-group">
                                                            <span class="input-group-text" title="Menu Name"
                                                                id="basic-addon1"><i class="fas fa-tags"
                                                                    title="Menu Name"></i></span>
                                                            <input type="text" value="" class=" form-control"
                                                                name="name" placeholder="Enter New Menu Name" required>
                                                        </div>
                                                    </div>

                                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                                                        <button type="submit"
                                                            class="add-to-cart btn btn-success btn-block"><i
                                                                class="fas fa-plus"></i> Create New Menu</button>
                                                    </div>
                                                </div>
                                            </form>
                                        @else
                                            @if ($desiredMenu)
                                                @if (count($menuitems) > 0)
                                                    <div class="row">
                                                        <h4 class="pl-3">Drag each item into the order you prefer. Click
                                                            the arrow on the right of the item to reveal additional
                                                            configuration options.</h4>
                                                        <h4 class="font-weight-bolder mt-2 mb-3 pl-3 text-success">Menu
                                                            Name:
                                                            <span
                                                                class="text-danger">{{ $desiredMenu->name ?? 'Null' }}</span>
                                                                        ...
                                                                        <li class="dd-item dd3-item"
                                                                            ...
                                                                            <div class="dd3-content shadow">
                                                                                ...
                                                                                <button
                                                                                    ...
                                                                                    class="pull-right collapse_angle"
                                                                            ...
                                                                            <div class="collapse"
                                                                                ...
                                                                                <div class="card shadow-lg p-3">
                                                                                    ...
                                                                                    <div class="card-body">
                                                                                        <form method="post"
                                                                                            action="{{ route('admin.updateMenuItem', $menuitem->id) }}">
                                                                                            @csrf
                                                                                            <div class="row">
                                                                                                <div class="col-sm-6">
                                                                                                    <div
                                                                                                ...
                                                                                                @endif --}}
                                                                                                <div
                                                                                                    class="col-sm-12 mt-3 text-right">
                                                                                                    <button
                                                                                            ...
                                                                                            <div class="collapse"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div class="card-body">
                                                                                                        <form
                                                                                                            method="post"
                                                                                                            action="{{ route('admin.updateMenuItem', $subMenu->id) }}">
                                                                                                            @csrf
                                                                                                            <div
                                                                                                                class="row">
                                                                                                                <div
                                                                                                        ...
                                                                                                        <button
                                                                                                            ...
                                                                                                            onclick="deleteMenuItem({{ $subMenu->id }})"
                                                                                                            class="btn btn-danger"
                                                                                                            style="float: right"><i
                                                                                                                class="fas fa-trash"></i>
                                                                                                            Delete</button>
                                                                                                            ...
                                                                                                            <div class="collapse"
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <form
                                                                                                                            method="post"
                                                                                                                            action="{{ route('admin.updateMenuItem', $childMenu->id) }}">
                                                                                                                            @csrf
                                                                                                                            <div
                                                                                                                                class="row">
                                                                                                                                <div
                                                                                                                        ...
                                                                                                                        <button
                                                                                                                            href="javascript:void(0)"
                                                                                                                            onclick="deleteMenuItem({{ $childMenu->id }})"
                                                                                                                            class="btn btn-danger"
                                                                                                                            style="float: right;"><i
                                                                                                                                class="fas fa-trash"></i>
                                                                                                                            Delete</button>
                                                ...
                                                @else
                                                    <h5>Menu item not found, please add menu items from the column on the
                                                        left.</h5>
                                                    ...
                                                    <h3 class="font-weight-bolder text-success mt-2 mb-2">Menu Location:
                                                    </h3>
                                                    <hr>
                                                    <div
                                                        class="custom-control custom-radio custom-control-success custom-control-lg mb-1">
                                                        <input type="radio" class="custom-control-input"
                                                            id="example-rd-custom-success-lg4" name="location"
                                                            value="main_header"
                                                            @if ($desiredMenu->location == 'main_header') checked @endif
                                                            required="">
                                                        <label class="custom-control-label"
                                                            for="example-rd-custom-success-lg4"
                                                            style="cursor: pointer;">Header Menu</label>
                                                    </div>
                                                    <div
                                                        class="custom-control custom-radio custom-control-success custom-control-lg mb-1">
                                                        <input type="radio" class="custom-control-input"
                                                            id="example-rd-custom-success-lg7" name="location"
                                                            value="footer1"
                                                            @if ($desiredMenu->location == 'footer1') checked @endif
                                                            required="">
                                                        <label class="custom-control-label"
                                                            for="example-rd-custom-success-lg7"
                                                            style="cursor: pointer;">Footer Menu</label>
                                                    </div>
                                                ...
                                                <label class="custom-control-label" for="example-rd-custom-success-lg8" style="cursor: pointer;">Footer Bottom Menu</label>
                                            </div>
                                                    <strong id="location"
                                                        class="text-danger font-weaight-bolder"></strong>

                                                    <div class="mt-3">
                                                        {{-- <button id="createMenu" class="btn btn-success"
                                                            style="float: right;">
    ...
    var ids = [];
    $("input[name='select-page[]']:checked:not(:disabled)").each(function() {
        ids.push($(this).val());
    });

    if (ids.length === 0) {
        $('#pages').html('No new pages selected to add.');
        return false;
    }
