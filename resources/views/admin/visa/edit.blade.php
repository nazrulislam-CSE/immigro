                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="country_name" id="country_name" class="form-control"
                                   placeholder="e.g., United States" value="{{ old('country_name', $visa->country_name) }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="flug" id="flug" class="form-control" accept="image/*"
                                   placeholder="Upload new flag image (optional)">
                            @error('flug') <span class="text-danger">{{ $message }}</span> @enderror
                            <img id="showImage" src="{{ $visa->flug ? asset('upload/visa/'.$visa->flug) : asset('upload/no_image.jpg') }}" alt="Flag Preview" width="80" class="mt-2">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="visa_category" id="visa_category" class="form-control"
                                   placeholder="e.g., Tourist, Business, Student" value="{{ old('visa_category', $visa->visa_category) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="work_category" id="work_category" class="form-control"
                                   placeholder="e.g., IT, Healthcare, Construction" value="{{ old('work_category', $visa->work_category) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="company_contact" id="company_contact" class="form-control"
                                   placeholder="Phone/Email of company" value="{{ old('company_contact', $visa->company_contact) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="processing_time" id="processing_time" class="form-control"
                                   placeholder="e.g., 5-7 business days" value="{{ old('processing_time', $visa->processing_time) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="apply_fee" id="apply_fee" class="form-control"
                                   placeholder="0.00" value="{{ old('apply_fee', $visa->apply_fee) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="medical_fee" id="medical_fee" class="form-control"
                                   placeholder="0.00" value="{{ old('medical_fee', $visa->medical_fee) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="agent_rate" id="agent_rate" class="form-control"
                                   placeholder="0.00" value="{{ old('agent_rate', $visa->agent_rate) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="customer_rate" id="customer_rate" class="form-control"
                                   placeholder="0.00" value="{{ old('customer_rate', $visa->customer_rate) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="advance_payment" id="advance_payment" class="form-control"
                                   placeholder="0.00" value="{{ old('advance_payment', $visa->advance_payment) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="after_visa_payment" id="after_visa_payment" class="form-control"
                                   placeholder="0.00" value="{{ old('after_visa_payment', $visa->after_visa_payment) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" name="manpower_ticket" id="manpower_ticket" class="form-control"
                                   placeholder="0.00" value="{{ old('manpower_ticket', $visa->manpower_ticket) }}">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="documents" id="documents" class="form-control summernote"
                                      placeholder="Enter required documents details...">{{ old('documents', $visa->documents) }}</textarea>
                        </div>
...
<script>
    $(document).ready(function(){
        // Optionally, you can also auto-generate slug on country name change in edit
        $('#country_name').on('keyup', function() {
            ...
            let slug = country.toLowerCase()
                ...
                .replace(/--+/g, '-')
                .trim();
            // Only fill if slug field is empty or user hasn't manually changed it?
            if ($('#slug').val().trim() === '' || $('#slug').val() === old_slug) {
                $('#slug').val(slug);
            }
        });
