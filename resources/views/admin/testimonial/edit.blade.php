...
<div class="breadcrumb-header justify-content-between">
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex">
                <a href="{{ route('admin.testimonial.index')}}" class="btn btn-danger me-2">
                    <i class="fas fa-list d-inline"></i> Testimonial List
                </a>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.testimonial.update',$testimonial->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       ...
                       @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $testimonial->name }}" class=" form-control" name="name" placeholder="Enter Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('designation') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ $testimonial->designation }}" class=" form-control" name="designation" placeholder="Enter Designation">
                         </div>
                     </div>
                   ...
                   <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       <img id="showImage" src="{{ (!empty($testimonial->image)) ? url('upload/testimonial/'.$testimonial->image):url('upload/no_image.jpg') }}" alt="Admin" style="width:100px; height: 100px;"  >
                   </div>

                    <div class="form-group col-xl-12 col-lg-12  col-md-6">
                        <label for="description">Description:</label>
                        @error('description') <span class="text-danger">{{ $message }}</span> @enderror
                        <textarea name="description" id="description">{{ $testimonial->description }}</textarea>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-paper-plane"></i> Update Testimonial</button>
                    </div>
                </div>
            </form>
        </div>
