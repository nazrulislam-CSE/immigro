    ...
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu ">
                ...
                <li class="slide {{ Request::is('admin/visa*') || Request::is('admin/student/visa*') || Request::is('admin/medical/visa*') ? 'is-expanded' : '' }}">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                ...
                <li class="slide {{ Request::is('admin/books*') ? 'is-expanded' : '' }}">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item {{ Request::is('admin/books/index') ? 'active' : '' }}" href="{{ route('admin.book.sale.list')}}">Books List</a></li>
                    </ul>
                </li>
                @endif
                ...
                <li class="slide {{ Request::is('admin/products*') ? 'is-expanded' : '' }}">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endif
                        @if($isSuperAdmin || $admin->can('view Products')) {{-- view product orders --}}
                ...
                <li class="slide {{ Request::is('admin/income*') || Request::is('admin/expense*') || Request::is('admin/account-statement*') || Request::is('admin/due-list*') ? 'is-expanded' : '' }}">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                        <i class="side-menu__icon fas fa-building"></i>
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item {{ Request::is('admin/account-statement') ? 'active' : '' }}" href="{{ route('admin.account.statement') }}">Account Statement</a></li>
                        @endif
                        @if($isSuperAdmin || $admin->can('view due list'))
                        <li><a class="slide-item {{ Request::is('admin/due-list') ? 'active' : '' }}" href="{{ route('admin.due.list') }}">Due List</a></li>
                        @endif
                    </ul>
                </li>
                @endif
