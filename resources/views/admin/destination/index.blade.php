                ...
                <div class="card">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                        <p class="card-title my-0">{{ $pageTitle ?? 'Page Title' }} <span class="badge bg-danger side-badge"
                                style="font-size:17px;">{{ count($destinations) }}</span> </p>

                        <div class="d-flex">
                            <a href="{{ route('admin.destination.create') }}" class="btn btn-success me-2">
                                <i class="fas fa-plus d-inline"></i> Add Now Destination
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="file-datatable"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">Package Count</th>
                                ...
                                <tbody>
                                    @foreach ($destinations as $key => $destination)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.destination.show', $destination->id) }}"
                                                ...
                                                <a href="{{ route('admin.destination.delete', $destination->id) }}"
