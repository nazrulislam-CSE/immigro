                                ...
                                <table id="file-datatable" class="border-top-0  table table-bordered text-nowrap key-buttons border-bottom">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom-0">Mission</th>
                                            <th class="border-bottom-0">Vission</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{!! Str::words(strip_tags($about->mission ?? ''), 5, '...') !!}</td>
                                            <td>{!! Str::words(strip_tags($about->vission ?? ''), 5, '...') !!}</td>
                                            <td>{!! Str::words(strip_tags($about->description ?? ''), 5, '...') !!}</td>
                                            <td>
                                                @if($about->status == 1)
